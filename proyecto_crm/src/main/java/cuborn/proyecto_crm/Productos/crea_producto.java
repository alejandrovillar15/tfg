...
public class crea_producto extends ArrayAdapter {

    private final Activity contexto;
    private final ArrayList<String> nombres, telegrams, mails, telefonos, imagenes;
    private final ArrayList<Integer> ids;

    public crea_producto(@NonNull Activity contexto, ArrayList<Integer> ids, ArrayList<String> nombres,
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        View FilaCliente = inflater.inflate(R.layout.fila_producto_vista,null,true);
